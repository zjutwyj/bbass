 ...
 *
 * https://github.com/re54k/mobileweb-utilities
 *
...
window.mobileUtil = (function(win, doc) {
  var UA = navigator.userAgent,
    ...
    isMobile = navigator.userAgent.toLowerCase().match(/(iPad|ipod|iphone|android|coolpad|mmp|smartphone|midp|wap|xoom|symbian|j2me|blackberry|win ce)/i) != null;  // 粗略的判断
